// tests/tasks.spec.js
// This is the "robot" that opens index.html and pretends to be a user:
// adding a task, checking it off, and deleting it. It checks that the
// app behaves correctly after each action.
...
test.beforeEach(async ({ page }) => {
  ...
  // Start each test with a clean slate (no leftover tasks from a previous run)
